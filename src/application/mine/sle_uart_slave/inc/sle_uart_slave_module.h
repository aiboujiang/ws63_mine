...
#define MINE_OLED_STATE_LINE_COUNT 2
#define MINE_OLED_STATE_TOTAL_CHARS (MINE_OLED_LINE_CHARS * MINE_OLED_STATE_LINE_COUNT)
#define MINE_OLED_DATA_LINE_COUNT 2
...
#define MINE_OLED_LINE_STATE0 1
#define MINE_OLED_LINE_STATE1 2
#define MINE_OLED_LINE_STATE MINE_OLED_LINE_STATE0
#define MINE_OLED_LINE_DATA0 3
#define MINE_OLED_LINE_DATA1 4
